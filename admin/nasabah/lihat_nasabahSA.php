...
$query2=mysql_query("SELECT * FROM nasabah ORDER BY saldo ASC");
...
<table class="table-data" border=1 width=100% border=0 >
    ...
    <tr>
        ...
        <td class="head-data"><a href='?page=lihat_nasabahN&sort=asc'>Nama</a></td>
        <td class="head-data">Alamat</td>
        <td class="head-data">Tanggal Lahir</td>
        <td class="head-data"><a href='?page=lihat_nasabahSD'>Saldo</a></td>
        <td class="head-data"><a href='?page=lihat_nasabahPA'>Peringkat</a></td>
