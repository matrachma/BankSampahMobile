...
$query3=mysql_query("SELECT * FROM lognasabah WHERE id_N = '$sesi'");
if (!$query3) { // add this check.
        ...
        <div data-role="content">   
	        ...
	        <div class='inset'>
                ...
                <table data-role="table" id="table-column-toggle" data-mode="columntoggle" class="ui-responsive table-stroke">
                  ...
                  <tbody>
                  <?php
                     while ($datam=mysql_fetch_array($query3)){
                      echo "
                            <tr>";
                         $tanggal=$datam['tanggal'];
                         $tgl= date('d-m-Y', strtotime($tanggal ));
                         echo "
                              <th>$tgl</th>
                              <td>$datam[aktivitas]</td>
                            </tr>";
                      }
                  ?>
                  </tbody>
